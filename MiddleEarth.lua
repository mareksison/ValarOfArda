...
if ModUtil ~= nil then
    ...
    if CodexMenu ~= nil then
        ...
        --Manwe
        if ModUtil.Mods.Data["ManweValar"] ~= nil then
            OlympusCodexMenuData.ManweUpgrade = {
